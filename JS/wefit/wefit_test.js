...
function step_Task1() {
 return new Promise(async resolve => {
const option =  {
     url: "https://inf-prdapi.wesure.cn/prdapp/api/v1/wesure-lottery-stepking-b/stepMoneyWebTask",
	 headers:JSON.parse(wefitHD2),
	 body:{
       //"requestId": "c9c21541", //变
	   "requestId": "${HD2.Ws-Request-Id}",
       "appId": "wx06a561655ab8f5b2",
       "cmd": "stepMoneyWebTask",
       //"sessionId": "55663162605932622271145", //变
	   "sessionId": "${HD2.Ws-sessionId}", 
       "userId": "oc2P70JNuJFDIaFjy1QA6FAYzvs8",
       //"token": "6F36614A10D8CABE9D5F0AF195E367BA", //变
       ...
       "body": {
          //"taskID": "1263d8e8ce5243b69f807b05231cc23e"
          "taskID": "8a5b538fce944e39847c1a1fde55e88f"
          }
        },
	 timeout: 6000,
   };
