...
function taskid4_new(ticket) {
  return new Promise((resolve, reject) => {
    let testurl = {
      url: `https://wzq.tenpay.com/cgi-bin/activity_task.fcgi?id=4&tid=49&task_ticket=${ticket}&actid=1111&channel=1&action=taskdone&_rndtime=${rndtime}&_appName=ios${taskheaderVal}`,
